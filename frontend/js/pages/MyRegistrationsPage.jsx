...
export default function MyRegistrationsPage() {
  ...
  const handleQRScanSuccess = async (decodedText) => {
    try {
      ...
      // Show loading toast
      const loadingToast = toast.loading('Проверка QR-кода...', {
        description: 'Выполняем check-in...',
      });
      ...
      toast.error('Ошибка check-in', {
        description: err.response?.data?.message || err.message || 'Неверный QR-код',
      });
    }
  };
