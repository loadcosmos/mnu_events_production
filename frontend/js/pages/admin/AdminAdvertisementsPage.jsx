        ...
        <div className="container max-w-7xl mx-auto py-8 px-4 space-y-6">
            ...
            {showCreateForm && (
                <Card className="border-[#d62e1f]/30 bg-white dark:bg-[#1a1a1a]">
                    <CardHeader>
                        <CardTitle className="text-gray-900 dark:text-white">Create New Advertisement</CardTitle>
                        <CardDescription>Fill in the details to create a new ad banner</CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <Card className="border-gray-200 dark:border-white/10 bg-white dark:bg-white/5">
                        <CardContent className="py-12">
                            <div className="text-center space-y-3">
                                ...
                                <p className="text-xl font-medium text-gray-900 dark:text-white">No advertisements yet</p>
                                <p className="text-gray-600 dark:text-gray-400">
                                    Create your first ad to start displaying on the homepage
                                </p>
                                <Button
