 ...
 * Sidebar слева, минималистичный дизайн: оранжевый, белый, черный
 */
export default function PartnerLayout({ children }) {
    ...
    const navItems = [
        ...
        { path: '/partner/events', label: 'My Events', icon: '📅' },
        { path: '/partner/create-event', label: 'Create Event', icon: '➕' },
        { path: '/partner/payments', label: 'Payment Verification', icon: '💳' },
    ];
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className={cn("h-16 border-b border-white/10 flex items-center px-4", !isMobile && "rounded-2xl")}>
                        {(sidebarOpen || isMobile) ? (
                            <Link to="/partner" className="flex items-center space-x-2" onClick={handleNavClick}>
                                <div className="w-8 h-8 bg-orange-600 rounded-2xl flex items-center justify-center text-white font-bold">
                                    P
                                </div>
                                <span className="font-bold text-lg">Partner</span>
                            </Link>
                        ) : (
                            <Link to="/partner" className="flex items-center justify-center w-full">
                                <div className="w-8 h-8 bg-orange-600 rounded-2xl flex items-center justify-center text-white font-bold">
                                    P
                                </div>
                            </Link>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-gray-400 truncate">Partner</p>
                                    </div>
                                </div>
                                <Button
